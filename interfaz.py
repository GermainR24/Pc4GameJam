...
pygame.display.set_caption("Selección de Equipo - Futbol FC")
...
def iniciar_juego():
    ...
    pygame.display.set_caption("Selección de Equipo - Futobol FC")
...
while True:
    ...
    texto_titulo = FUENTE_TITULO.render("Seleccion Equipo", True, AMARILLO_TEXTO)
