...
class GestorSonidos:
    def __init__(self):
        ...
        self.lista_archivos = {
            ...
            # Ultis para cada personaje 
            'ulti_curie': 'ulti_curie.wav',     
            'ulti_einstein': 'ulti_einstein.wav', 
            'ulti_gauss': 'ulti_gauss.wav',     
            'ulti_steve': 'ulti_steve.wav',     
            'ulti_tesla': 'ulti_tesla.wav'      
        }
